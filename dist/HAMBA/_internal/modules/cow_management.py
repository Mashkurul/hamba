# =============================================================
# modules/cow_management.py - Cow Management Module
# =============================================================
# Handles all cow-related operations:
#   - Add Cow
#   - View All Cows
#   - Search Cow
#   - Update Cow
...
# ---------------------------------------------------------
# Feature 3: Search cow by name or ID
# ---------------------------------------------------------
def search_cow():
    ...
    try:
        ...
        # Search by ID if it's a number, otherwise by name
        if keyword.isdigit():
...
# ---------------------------------------------------------
# Feature 4: Update cow information
# ---------------------------------------------------------
def update_cow():
    ...
    try:
        ...
        # Show current values and let user update
