# =============================================================
# modules/food_management.py - Food Management Module
# =============================================================
# Handles all feed/food-related operations:
#   - Add Feed Schedule / Food Stock
#   - View Food Stock
...
# ---------------------------------------------------------
# Feature 1: Add food stock / feed record
# ---------------------------------------------------------
def add_feed():
...
# ---------------------------------------------------------
# Feature 2: View food stock / all feed records
# ---------------------------------------------------------
def view_food_stock():
...
# ---------------------------------------------------------
# Feature 3: Daily feeding – records for today
# ---------------------------------------------------------
def daily_feeding():
...
# ---------------------------------------------------------
# Feature 4: Update a feed record
# ---------------------------------------------------------
def update_feed():
...
# ---------------------------------------------------------
# Feature 5: Delete a feed record
# ---------------------------------------------------------
def delete_feed():
